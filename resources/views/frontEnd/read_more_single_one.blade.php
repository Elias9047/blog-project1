                    ...
                    <div class="blog-content-wrap">
                        <div class="blog-title-wrap">
                            <div class="author-date">
                                <a class="author" href="#">
                                    <img src="{{ asset($blogs->image) }}" alt="" class="rounded-circle" />
                                    <span class="">{{ asset($blogs->author_relation->author_name) }}</span>
                                </a>
                                <a class="date" href="#">
                                    <span>Posted on 21 Dec, 2019</span>
                                </a>
                            </div>
                        ...
                        <div class="blog-desc">
                            {{ $blogs->description }}
{{--                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia officia dolores--}}
{{--                                aspernatur distinctio at, voluptatum molestiae excepturi nam quos fuga animi, facere--}}
{{--                                porro ducimus. Explicabo deserunt magni molestiae, amet et omnis delectus laborum--}}
{{--                                dolorum ipsam, labore, perspiciatis quaerat neque! Ab esse dolorum earum beatae--}}
{{--                                fugiat similique eos voluptates suscipit repudiandae?</p>--}}
...
{{--                                blanditiis corporis inventore assumenda non, nisi voluptatem aperiam libero officia--}}
{{--                                beatae dignissimos earum ratione explicabo? Adipisci, dolor!</p>--}}
{{--                            <img src="{{ asset('frontAsset') }}/assets/images/winter.jpg" alt="">--}}
...
{{--                                rem labore consectetur repellendus.</p>--}}
                        ...
                        <div class="tags-wrap">
                            ...
                            <div class="share-buttons">
                                <p>Share Now:</p>
                                <ul class="share-list">
                                    <li><a href="#"><img src="{{ asset('frontAsset') }}/assets/images/facebook.png" alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('frontAsset') }}/assets/images/twitter.png" alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('frontAsset') }}/assets/images/pinterest.png" alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('frontAsset') }}/assets/images/messenger.png" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="blog-author-info">
                            <div class="author-img">
                                <img src="{{ asset('frontAsset') }}/assets/images/writer.jpg" alt="">
                            </div>
                            ...
                            <div class="collapse" id="collapseExample">
                                <div class="card comment-card">
                                    <div class="card-body">
                                        <div class="author-date">
                                            <div class="author">
                                                <img src="{{ asset('frontAsset') }}/assets/images/person1.jpg" alt="" class="rounded-circle" />
                                            </div>
                                    ...
                                    <div class="card comment-card">
                                        <div class="card-body">
                                            <div class="author-date">
                                                <div class="author">
                                                    <img src="{{ asset('frontAsset') }}/assets/images/writer.jpg" alt="" class="rounded-circle" />
                                                </div>
                                                <div class="inner-author-date">
                                                    <div class="author">
                                ...
                                <div class="card comment-card">
                                    <div class="card-body">
                                        <div class="author-date">
                                            <div class="author">
                                                <img src="{{ asset('frontAsset') }}/assets/images/person2.jpg" alt="" class="rounded-circle" />
                                            </div>
                                            <div class="inner-author-date">
                                                <div class="author">
                                ...
                                <div class="card comment-card">
                                    <div class="card-body">
                                        <div class="author-date">
                                            <div class="author">
                                                <img src="{{ asset('frontAsset') }}/assets/images/person3.jpg" alt="" class="rounded-circle" />
                                            </div>
                                            <div class="inner-author-date">
                                                <div class="author">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="card small-card simple-overlay-card">
                        <a href="#"><img src="{{ asset('frontAsset') }}/assets/images/town-street.jpg" class="card-img" alt="" /></a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card small-card simple-overlay-card">
                        <a href="#"><img src="{{ asset('frontAsset') }}/assets/images/camera.jpg" class="card-img" alt="" /></a>
                        <div class="card-img-overlay">
                            <ul class="category-tag-list mb-0">
                                <li class="category-tag-name">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card small-card simple-overlay-card">
                        <a href="#"><img src="{{ asset('frontAsset') }}/assets/images/winter-house.jpg" class="card-img" alt="" /></a>
                        <div class="card-img-overlay">
                            <ul class="category-tag-list mb-0">
                                <li class="category-tag-name">
                                    <a href="#">Lifestyle</a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card small-card simple-overlay-card">
                        <a href="#"><img src="{{ asset('frontAsset') }}/assets/images/shoes.jpg" class="card-img" alt="" /></a>
                        <div class="card-img-overlay">
                            <ul class="category-tag-list mb-0">
                                <li class="category-tag-name">
                                    <a href="#">Travel</a>
