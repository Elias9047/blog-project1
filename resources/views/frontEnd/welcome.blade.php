                        ...
                        <div class="banner-carousel">
                            <div class="banner-item">
                                <div class="banner-img">
                                    <a href="single-layout-one.html"> <img src="{{ 'frontAsset' }}/assets/images/banner-1.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="banner-item">
                                ...
                                <div class="banner-img">
                                    <a href="single-layout-one.html">
                                        <img src="{{ 'frontAsset' }}/assets/images/london.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="banner-item">
                                ...
                                <div class="banner-img">
                                    <a href="single-layout-one.html">
                                        <img src="{{ 'frontAsset' }}/assets/images/houses.jpg" alt="">
            ...
            <div class="more-content-grid py-30">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/bus.jpg" class="card-img-top " alt="" />
                            </a>
                            <div class="card-body px-0">
                                ...
                                <div class="author-date">
                                    <a class="author" href="#">
                                        <img src="{{ 'frontAsset' }}/assets/images/writer.jpg" alt="" class="rounded-circle" />
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/roaming.jpg" class="card-img-top " alt="" />
                            </a>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/paris.jpg" class="card-img-top " alt="" />
                            </a>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-7">
                    <div class="featured-left">
                        <div class="card">
                            <a href="single-layout-one.html"><img src="{{ 'frontAsset' }}/assets/images/girl.jpg" class="card-img " alt="" /></a>
                ...
                <div class="col-md-12 col-lg-5">
                    <div class="featured-right">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/umbrella.jpg" class="card-img-top " alt="">
                            </a>
                            <div class="card-body">
                                <ul class="category-tag-list">
                        ...
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/streets.jpg" class="card-img-top " alt="">
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-lg-8">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="author-date">
                                        <a class="author" href="#">
                                            <img src="{{ asset($blog->author_relation->image) }}" alt="" class="rounded-circle" />
                                            <span class="writer-name-small">{{ $blog->author_relation->author_name }}</span>
                                        </a>
                                        <a class="btn btn-success" href="{{ route('read_more.blog',['slug'=>$blog->slug]) }}">Read more</a>
                                        <a class="date" href="#">
                                            <span>21 Dec, 2019</span>
                                        </a>
                                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html"> <img src="{{ 'frontAsset' }}/assets/images/alone-house.jpg" class="card-img " alt=""></a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <ul class="category-tag-list">
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html"><img src="{{ 'frontAsset' }}/assets/images/taj.jpg" class="card-img " alt=""></a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <ul class="category-tag-list">
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html"><img src="{{ 'frontAsset' }}/assets/images/camera.jpg" class="card-img " alt=""></a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <ul class="category-tag-list">
            ...
            <div class="more-content-grid ">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/lights.jpg" class="card-img-top" alt="" />
                            </a>
                            <div class="card-body px-0">
                                <ul class="category-tag-list">
                                    <li class="category-tag-name">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/lighthouse.jpg" class="card-img-top" alt="" />
                            </a>
                            <div class="card-body px-0">
                                <ul class="category-tag-list">
                                    <li class="category-tag-name">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/woods.jpg" class="card-img-top" alt="" />
                            </a>
                            <div class="card-body px-0">
                                <ul class="category-tag-list">
                                    <li class="category-tag-name">
    ...
    <section class="insta-posts">
        <div class="container">
            <div class="insta-title">
                <img src="{{ 'frontAsset' }}/assets/images/instagram.svg" alt="">
            ...
            <div class="image-item-grid insta-slider">
                ...
                <div class="image-item">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/beautiful-girl.jpg" alt="">
                    </a>
                    <a href="#">
                ...
                <div class="image-item image-item-margin">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/colors.jpg" alt="">
                    </a>
                    <a href="#">
                        <div class="image-hover">
                            <i class="fas fa-heart"></i>
                ...
                <div class="image-item">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/city-pink.jpg" alt="">
                    </a>
                    <a href="#">
                        <div class="image-hover">
                            <i class="fas fa-heart"></i>
                ...
                <div class="image-item image-item-margin">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/sea-lighthouse.jpg" alt="">
                    </a>
                    <a href="#">
                        <div class="image-hover">
                            <i class="fas fa-heart"></i>
                ...
                <div class="image-item">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/boat.jpg" alt="">
                    </a>
                    <a href="#">
                        <div class="image-hover">
                            <i class="fas fa-heart"></i>
                ...
                <div class="image-item">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/beach-sea.jpg" alt="">
                    </a>
                    <a href="#">
                        <div class="image-hover">
                            <i class="fas fa-heart"></i>
                ...
                <div class="image-item">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/orange-bus.jpg" alt="">
                    </a>
                    <a href="#">
                        <div class="image-hover">
                            <i class="fas fa-heart"></i>
                ...
                <div class="image-item">
                    <a href="#">
                        <img src="{{ 'frontAsset' }}/assets/images/tall.jpg" alt="">
                    </a>
                    <a href="#">
                        <div class="image-hover">
                            <i class="fas fa-heart"></i>
