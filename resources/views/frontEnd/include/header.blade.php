    ...
    <div class="sticky-sidebar">
        <div class="sticky-sidebar-content">
            ...
            <div class="author-img">
                <img src="{{ 'frontAsset' }}/assets/images/author.jpg" alt="">
            </div>
            ...
            <div class="author-posts">
                    ...
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/time.jpg" class="card-img" alt="">
                            </a>
                        </div>
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/alone.jpg" class="card-img" alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/forest.jpg" class="card-img" alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{ 'frontAsset' }}/assets/images/beach-sea.jpg" class="card-img" alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                            <div class="card-body">
