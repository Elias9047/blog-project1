...
<head>
    ...
    <link href="{{ asset('backEndAsset') }}/assets/css/all.min.css" rel="stylesheet" />
...
<div class="wrapper">
    <!--start top header-->
    @include('backEnd.dashboard.include.header')
    <!--end top header-->

    <!--start sidebar -->
   @include('backEnd.dashboard.include.sidebar')
    <!--start sidebar -->
...
<script src="{{ asset('backEndAsset') }}/assets/js/all.min.js"></script>
